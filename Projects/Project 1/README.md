# E-Commerce Transactions Data Quality Audit & Exploratory Analysis

<p align="center">
  <svg width="100%" height="120" viewBox="0 0 800 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="800" height="120" rx="8" fill="#1E293B"/>
    <text x="50%" y="40" fill="#38BDF8" font-family="'Inter', sans-serif" font-size="12" font-weight="600" letter-spacing="3" text-anchor="middle">PROJECT 01 — DECODELABS</text>
    <text x="50%" y="75" fill="#F8FAFC" font-family="'Inter', sans-serif" font-size="24" font-weight="800" letter-spacing="1" text-anchor="middle">E-COMMERCE DATA QUALITY AUDIT & EDA</text>
    <circle cx="400" cy="100" r="3" fill="#818CF8"/>
  </svg>
</p>
...
* **Product Sales Volume**: Shows Printers (181) and Tablets (179) leading in total order counts.
* **Product Total Revenue**: Tablets represent the largest gross revenue channel (Rs. 189K), followed closely by Phones (Rs. 176K).
<p align="center">
  <img src="images/univariate_product_distribution.png" width="45%" alt="Product Sales Volume"/>
  <img src="images/bivariate_revenue_by_product.png" width="45%" alt="Revenue by Product"/>
</p>

---

### 2. Order Fulfilment & Seasonality Trends
...
<p align="center">
  <img src="images/univariate_order_status.png" width="45%" alt="Order Status Distribution"/>
  <img src="images/bivariate_monthly_sales_trend.png" width="45%" alt="Seasonality Trends"/>
</p>

---

### 3. Customer Acquisition Efficiency
* **Channel ROI**: Highlights Instagram as the highest revenue driver (Rs. 237k), with Email running a close second (Rs. 222k).
<p align="center">
  <img src="images/bivariate_revenue_by_channel.png" width="60%" alt="Revenue by Acquisition Channel"/>
</p>
...
2. **Instagram & Email Outperform**: These two channels generate over **41%** of sales. We recommend diverting marketing budget away from lower-yield Facebook campaigns and into Instagram micro-influencers and high-intent email flows.
3. **Severe Operational Bottleneck**: **41.4%** of all customer orders result in a `Cancelled` or `Returned` status. This represents massive shipping overhead and processing loss. Strategic response: Implement strict buyer confirmation prompts and audit current third-party logistics (3PL) carriers for delivery delays.
...
10. **Customer Retention Plan**: With 1,189 unique customer IDs across 1,200 orders, retention is close to 0%. Launch a post-purchase loyalty program to increase secondary customer lifetime value (LTV).
...
[PASS] Checked 1200 rows: TotalPrice matches Quantity * UnitPrice * (1 - Discount).
